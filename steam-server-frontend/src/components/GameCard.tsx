      ...
      <div className="containerV">
        <div className="cardV">
          ...
          <svg className="cardV__svg" viewBox="0 0 800 500">
            ...
            <path className="cardV__line" d="M 0 100 Q 50 200 100 250 Q 250 400 350 300 C 400 250 550 150 650 300 Q 750 450 800 400" stroke="pink" stroke-width="3" fill="transparent" />
          </svg>
